...
class Request:
    ...
    def makeRequest(self, url):
        ...
        if r.status_code != 200:
            raise RuntimeError('got a non-200: {}'.format(r))
        try:
            return r.json()
        except JSONDecodeError:
            return None

    def candle(self, s, f, t):
        return self.makeRequest( self.config.fhBaseUrl+'/stock/candle?symbol='+s+'&resolution=1&from='+str(f)+'&to='+str(t+60))
